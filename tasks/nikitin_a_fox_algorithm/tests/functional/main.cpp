...
class NikitinAFoxAlgorithmFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_nikitin_a_fox_algorithm, "pic.jpg");
...
TEST_P(NikitinAFoxAlgorithmFuncTests, MatmulFromPic) {
...
INSTANTIATE_TEST_SUITE_P(PicMatrixTests, NikitinAFoxAlgorithmFuncTests, kGtestValues, kPerfTestName);
